...
public class MemberController {
	...
	@ResponseBody
	@RequestMapping(value = "/getSavePage", method = RequestMethod.POST)
	public HashMap<String, Object> getSavePage(HttpServletRequest req) throws Exception {
		int pageNum = Integer.parseInt(req.getParameter("pageNum"));
		int userID = Integer.parseInt(req.getParameter("userID"));
		// String flag = req.getParameter("flag");
		HashMap<String, Object> data = new HashMap<String, Object>();
		...
		List<SaveVO> save = null;
		save = boardService.saveList(userID);
		
		List<BoardVO> list = null;
		list = boardService.savePageList(save, page.getDisplayPost(), page.getPostNum());
