						...
						if (f.size < 31457280) {
							...
							tempImage.onload = function() {
								...
								var img_html = '<div class="middle" id="middle_'
										...
										+ index
										+ '" name="tp" value="sneakers" /><label><img src="/resources/imgs/sneakers.png">도보</label>'
										+ ' <input type="checkbox" id="bus_'
										+ index
										+ '" name="tp" value="bus" /><label><img src="/resources/imgs/bus.png">버스</label>'
										+ ' <input type="checkbox" id="train_'
										+ index
										+ '" name="tp" value="train" /><label><img src="/resources/imgs/train.png">기차</label>'
										+ ' <br>'
										+ ' <input type="checkbox" id="car_'
										+ index
										+ '" name="tp" value="car" /><label><img src="/resources/imgs/car.png">자동차</label>'
										+ '  <input type="checkbox" id="taxi_'
										+ index
										+ '" name="tp" value="taxi" /><label><img src="/resources/imgs/taxi.png">택시</label>'
										+ ' <input type="checkbox" id="bike_'
										+ index
										+ '" name="tp" value="bike" /><label><img src="/resources/imgs/bike.png">자전거</label>'
										+ ' <input type="checkbox" id="scooter_'
										+ index
										+ '" name="tp" value="scooter" /><label><img src="/resources/imgs/scooter.png">스쿠터</label></div></div></div></div><button type="button" id="b_'
										+ index
										+ '" onclick="del('
										+ index
										+ ')">삭제</button>'
