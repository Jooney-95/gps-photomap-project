...
function printImgBox(obj, tp) {
	...
	for (var i = 0; i < obj.length; i++) {
		var img_html = '  <div class="middle" id="middle_' + obj[i].id
				+ '" name="imgDiv">';
		...
		img_html += '                    <input type="hidden" id="id_'
				+ obj[i].id + '" name="id" value="' + obj[i].id + '">';
		img_html += '                    <input type="text"  id="loc_'
				+ obj[i].id + '" name="loc">';
		img_html += '                    <input type="hidden" id="lat_'
				+ obj[i].id + '" name="lat" />';
		img_html += '                    <input type="hidden" id="lon_'
				+ obj[i].id + '" name="lon" />';
		img_html += "                 </div>";
		img_html += "              </li>";
		img_html += "              <li>";
		...
		img_html += '             <div class="star"><button  type="button" class="star1"  id="selectLikeImg_'
				+ obj[i].id
		...
		img_html += '              <div class="time"> <input type="text" id="time_'
				+ obj[i].id
				+ '" name="time" value="'
				+ obj[i].timeView
				+ '"/> </div>';
		...
		img_html += '              <textarea style="width:90%" cols="30" rows="5" id="textarea_'
				+ obj[i].id
				+ '" name="content" placeholder="#해시태그"></textarea><br/>';
		img_html += "           </div>";
		img_html += "        </div>";
		img_html += "     </div>";
		img_html += '     <div class="down"><button type="button" id="b_'
				+ obj[i].id + '" onclick="deleteBtn(' + obj[i].id
				+ ')">삭제</button></div>';
